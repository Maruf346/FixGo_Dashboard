import svgPaths from "./svg-ce3cuf4rwc";
...
import imgEllipse19 from "./01b5423c092812e0e9f8a4698f9f3f7456e68368.png";
import imgImage41 from "./5078649ffbfe0692b5f7d58c8600d7ba802d1139.png";
import { imgUkFlag } from "./svg-h4b62";
...
function Users2() {
  return (
    <div className="content-stretch flex gap-[10px] items-center p-[12px] relative rounded-[4px] shrink-0 w-[250px]" style={{ backgroundImage: "linear-gradient(144.926deg, rgb(27, 69, 124) 12.093%, rgb(82, 134, 202) 87.907%)" }} data-name="Users">
      ...
      <p className="font-['Poppins:Medium',sans-serif] leading-[32px] not-italic relative shrink-0 text-[18px] text-white whitespace-nowrap">Artisan Management</p>
    </div>
  );
}
...
function Cell() {
  return (
    <div className="content-stretch flex gap-[8px] h-[72px] items-center justify-center p-[12px] relative shrink-0 w-[50px]" data-name="cell">
...
function Frame() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0">
      <div className="relative shrink-0 size-[16px]" data-name="image 41">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImage41} />
      </div>
      <p className="font-['Lato:Bold',sans-serif] leading-[16px] not-italic relative shrink-0 text-[#262626] text-[16px] whitespace-nowrap">5.0</p>
    </div>
  );
}
...
function Cell1() {
  return (
    <div className="content-stretch flex h-[80px] items-center p-[12px] relative shrink-0 w-[130px]" data-name="cell">
      <div aria-hidden="true" className="absolute border-[#f0f0f0] border-b border-solid inset-0 pointer-events-none" />
      <Frame />
    </div>
  );
...
function Cell2() {
  return (
    <div className="content-stretch flex gap-[8px] h-[80px] items-center justify-center p-[12px] relative shrink-0 w-[50px]" data-name="cell">
      <div aria-hidden="true" className="absolute border-[#f0f0f0] border-b border-solid inset-0 pointer-events-none" />
      <div className="overflow-clip relative shrink-0 size-[24px]" data-name="icon/mage:dots">
        <div className="absolute inset-[16.67%_46%]" data-name="Vector">
          <div className="absolute inset-[-4.69%_-39.06%]">
...
function Frame12() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0">
      <div className="content-stretch flex items-center justify-between relative shrink-0 w-[1102px]">
        <div className="content-stretch flex gap-[8px] h-[72px] items-center p-[12px] relative shrink-0 w-[148.4px]" data-name="cell">
          <div aria-hidden="true" className="absolute border-[#f0f0f0] border-b border-solid inset-0 pointer-events-none" />
        ...
        <div className="content-stretch flex gap-[8px] h-[72px] items-center p-[12px] relative shrink-0 w-[170px]" data-name="cell">
          <div aria-hidden="true" className="absolute border-[#f0f0f0] border-b border-solid inset-0 pointer-events-none" />
          <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#8c8c8c] text-[14px] tracking-[0.2px] whitespace-nowrap">
            <p className="leading-[1.5]">Email</p>
          </div>
        </div>
        <div className="content-stretch flex gap-[8px] h-[72px] items-center p-[12px] relative shrink-0 w-[160px]" data-name="cell">
          <div aria-hidden="true" className="absolute border-[#f0f0f0] border-b border-solid inset-0 pointer-events-none" />
          <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#8c8c8c] text-[14px] tracking-[0.2px] whitespace-nowrap">
        ...
        <div className="content-stretch flex gap-[8px] h-[72px] items-center p-[12px] relative shrink-0 w-[148.4px]" data-name="cell">
          <div aria-hidden="true" className="absolute border-[#f0f0f0] border-b border-solid inset-0 pointer-events-none" />
          <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#8c8c8c] text-[14px] tracking-[0.2px] whitespace-nowrap">
            <p className="leading-[1.5]">Jobs Completed</p>
          </div>
        </div>
        <div className="content-stretch flex gap-[8px] h-[72px] items-center p-[12px] relative shrink-0 w-[130px]" data-name="cell">
          <div aria-hidden="true" className="absolute border-[#f0f0f0] border-b border-solid inset-0 pointer-events-none" />
          <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#8c8c8c] text-[14px] tracking-[0.2px] whitespace-nowrap">
            <p className="leading-[1.5]">Rating</p>
          </div>
        </div>
        <div className="content-stretch flex gap-[8px] h-[72px] items-center p-[12px] relative shrink-0 w-[130px]" data-name="cell">
          <div aria-hidden="true" className="absolute border-[#f0f0f0] border-b border-solid inset-0 pointer-events-none" />
          <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#8c8c8c] text-[14px] tracking-[0.2px] whitespace-nowrap">
            <p className="leading-[1.5]">Last Active</p>
          </div>
        </div>
        <div className="content-stretch flex gap-[8px] h-[72px] items-center p-[12px] relative shrink-0 w-[148.4px]" data-name="cell">
          <div aria-hidden="true" className="absolute border-[#f0f0f0] border-b border-solid inset-0 pointer-events-none" />
      ...
      <div className="content-stretch flex items-center justify-between relative shrink-0 w-[1102px]">
        <div className="flex-[1_0_0] h-[80px] min-w-px relative" data-name="cell">
          <div aria-hidden="true" className="absolute border-[#f0f0f0] border-b border-solid inset-0 pointer-events-none" />
          <div className="flex flex-row items-center size-full">
        ...
        <div className="content-stretch flex h-[80px] items-center p-[12px] relative shrink-0 w-[170px]" data-name="cell">
          <div aria-hidden="true" className="absolute border-[#f0f0f0] border-b border-solid inset-0 pointer-events-none" />
          <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#262626] text-[14px] tracking-[0.3px] whitespace-nowrap">
            <p className="leading-[1.5]">justinleo@gmail.com</p>
          </div>
        </div>
        <div className="content-stretch flex h-[80px] items-center p-[12px] relative shrink-0 w-[160px]" data-name="cell">
          <div aria-hidden="true" className="absolute border-[#f0f0f0] border-b border-solid inset-0 pointer-events-none" />
          <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#262626] text-[14px] tracking-[0.3px] whitespace-nowrap">
            <p className="leading-[1.5]">+1 887 839 8383</p>
          </div>
        </div>
        <div className="flex-[1_0_0] h-[80px] min-w-px relative" data-name="cell">
          <div aria-hidden="true" className="absolute border-[#f0f0f0] border-b border-solid inset-0 pointer-events-none" />
          <div className="flex flex-row items-center size-full">
            <div className="content-stretch flex items-center p-[12px] relative size-full">
              <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#262626] text-[14px] tracking-[0.3px] whitespace-nowrap">
                <p className="leading-[1.5]">{`30 completed `}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="content-stretch flex h-[80px] items-center p-[12px] relative shrink-0 w-[130px]" data-name="cell">
          <div aria-hidden="true" className="absolute border-[#f0f0f0] border-b border-solid inset-0 pointer-events-none" />
          <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#262626] text-[14px] tracking-[0.3px] whitespace-nowrap">
            <p className="leading-[1.5]">1h ago</p>
          </div>
        </div>
        <div className="flex-[1_0_0] h-[80px] min-w-px relative" data-name="cell">
          <div aria-hidden="true" className="absolute border-[#f0f0f0] border-b border-solid inset-0 pointer-events-none" />
          <div className="flex flex-row items-center size-full">
            <div className="content-stretch flex items-center p-[12px] relative size-full">
              <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#262626] text-[14px] tracking-[0.3px] whitespace-nowrap">
                <p className="leading-[1.5]">San Farncisco CA</p>
              </div>
            </div>
          </div>
        </div>
